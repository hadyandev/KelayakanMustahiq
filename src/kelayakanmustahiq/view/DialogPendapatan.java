 ...
 * @author Hadyan Ahmad
 */
public class DialogPendapatan extends javax.swing.JDialog {
     ...
     */
    public DialogPendapatan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setIcon();
    }
    ...
    private void setIcon() {
        URL iconURL = getClass().getResource("/kelayakanmustahiq/resource/notes_24px.png");
// iconURL is null when not found
    ...
    private void refreshDialog(){
        ...
        this.tfMin.setText(fvf.domainMin("Pendapatan").toString());
        this.tfMax.setText(fvf.domainMax("Pendapatan").toString());
    }
    ...
    private void btnSetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSetActionPerformed
        ...
        if(this.tfMin.getText().equals("")||this.tfMax.getText().equals("")){
            ...
            vf.setIdVariabel(fvf.idVariabel("Pendapatan"));
            vf.setNamaVariabel("Pendapatan");
            vf.setDomainMin(Integer.valueOf(this.tfMin.getText()));
            vf.setDomainMax(Integer.valueOf(this.tfMax.getText()));
            this.vfm.update(vf);
            JOptionPane.showMessageDialog(null, "Domain Pendapatan: ["+this.tfMin.getText()+", "+this.tfMax.getText()+"]");
            this.dispose();
        }        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogPendapatan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogPendapatan dialog = new DialogPendapatan(new javax.swing.JFrame(), true);
