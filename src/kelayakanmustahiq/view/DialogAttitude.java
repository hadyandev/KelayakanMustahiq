 ...
 * @author Hadyan Ahmad
 */
public class DialogAttitude extends javax.swing.JDialog {
    
    private final VariabelFuzzyModel vfm = new VariabelFuzzyModel();

    /**
     * Creates new form DialogDomainAttitude
     */
    public DialogAttitude(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setIcon();
    }
    ...
    private void setIcon() {
        URL iconURL = getClass().getResource("/kelayakanmustahiq/resource/user_24px.png");
// iconURL is null when not found
    ...
    private void refreshDialog(){
        ...
        this.tfMin.setText(fvf.domainMin("Attitude").toString());
        this.tfMax.setText(fvf.domainMax("Attitude").toString());
    }
    ...
    private void btnSetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSetActionPerformed
        ...
        if(this.tfMin.getText().equals("")||this.tfMax.getText().equals("")){
            ...
            vf.setIdVariabel(fvf.idVariabel("Attitude"));
            vf.setNamaVariabel("Attitude");
            vf.setDomainMin(Integer.valueOf(this.tfMin.getText()));
            vf.setDomainMax(Integer.valueOf(this.tfMax.getText()));
            this.vfm.update(vf);
            JOptionPane.showMessageDialog(null, "Domain Attitude: ["+this.tfMin.getText()+", "+this.tfMax.getText()+"]");
            this.dispose();
        }        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogAttitude.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogAttitude dialog = new DialogAttitude(new javax.swing.JFrame(), true);
