 ...
 * @author Hadyan Ahmad
 */
public class DialogTempatTinggal extends javax.swing.JDialog {
    
    private final VariabelFuzzyModel vfm = new VariabelFuzzyModel();

    /**
     * Creates new form DialogDomainBiaya
     */
    public DialogTempatTinggal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setIcon();
    }
    ...
    private void setIcon() {
        URL iconURL = getClass().getResource("/kelayakanmustahiq/resource/house_24px.png");
// iconURL is null when not found
    ...
    private void refreshDialog(){
        ...
        this.tfMin.setText(fvf.domainMin("Tempat Tinggal").toString());
        this.tfMax.setText(fvf.domainMax("Tempat Tinggal").toString());
    }
    ...
    private void initComponents() {
        ...
        setTitle("Domain Kualitas Tempat Tinggal");
    ...
    private void btnSetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSetActionPerformed
        ...
        if(this.tfMin.getText().equals("")||this.tfMax.getText().equals("")){
            ...
            vf.setIdVariabel(fvf.idVariabel("Tempat Tinggal"));
            vf.setNamaVariabel("Tempat Tinggal");
            vf.setDomainMin(Integer.valueOf(this.tfMin.getText()));
            vf.setDomainMax(Integer.valueOf(this.tfMax.getText()));
            this.vfm.update(vf);
            JOptionPane.showMessageDialog(null, "Domain Kelayakan Tempat Tinggal: ["+this.tfMin.getText()+", "+this.tfMax.getText()+"]");
            this.dispose();
        }        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogTempatTinggal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogTempatTinggal dialog = new DialogTempatTinggal(new javax.swing.JFrame(), true);
